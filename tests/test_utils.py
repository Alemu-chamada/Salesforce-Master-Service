...
def test_deep_serialize_handles_types():
    payload = {
        ...
        "datetime": _dt.datetime(2025, 1, 2, 3, 4, 5, tzinfo=_dt.timezone.utc),
...
def test_duration_and_pagination():
    start = _dt.datetime(2025, 1, 1, 0, 0, 0, tzinfo=_dt.timezone.utc)
    end = _dt.datetime(2025, 1, 1, 0, 0, 10, 500000, tzinfo=_dt.timezone.utc)
