...
SOQL_QUERIES: dict[str, str] = {
    ...
    "OpportunityContactRole": "SELECT Id, OpportunityId, ContactId, Role, IsPrimary, CreatedDate, LastModifiedDate FROM OpportunityContactRole",
    ...
    "CaseComment": "SELECT Id, ParentId, CommentBody, CreatedDate, CreatedById FROM CaseComment",
    ...
    "CampaignMember": "SELECT Id, CampaignId, LeadId, ContactId, Status, HasResponded, FirstRespondedDate, CreatedDate FROM CampaignMember",
